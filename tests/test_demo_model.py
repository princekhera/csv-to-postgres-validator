...
def test_age_group_boundary_mismatch_annotated_not_rejected(minimal_row):
    """Issue #12: a 12-year-old declared as Adolescent (13-17) is a
    boundary disagreement, not a miscoding. The row should be accepted
    with an annotation, not rejected.
    """
    row = DemoRow.model_validate({
        **minimal_row,
        "age": "12",
